...
class TestModel(models.Model):
    ...
    float_1x1x1x1 = MatrixField(datatype=float, dimensions=(1,1,1,1), blank=True)
...
class MatrixFieldDBTestCase(TestCase):
    ...
    def test_valid(self):
        ...
        self.assertEqual(m.float_1x1x1x1, M4),
    ...
    def test_invalid_type(self):
        ...
        with self.assertRaises(ValidationError):
            TestModel(float_1x1x1x1=[[[[2]]]]).full_clean()
    ...
    def test_invalid_dims(self):
        ...
        #with self.assertRaises(ValidationError):
        #    TestModel(float_1x1x1x1=[[2.0]]).full_clean()
